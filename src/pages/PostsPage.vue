      ...
      <b-media no-body>
        ...
        <b-media-body>
          ...
          <div class="forum-post-content">
            ...
            beta, and represents how the pack will be downloaded once it's actually released. Do please remember that this
            is a beta, lot's of stuff isn't done yet (server configs, game configs, touhou content), and the map might be
            wiped during the beta. The map WILL also be wiped at the end of the beta. So, how do you access it? It's still
            a bit complicated at this point, but easier than installing a beta has ever been. Either you can go here
            <a href="https://minecraft.curseforge.com/projects/release-the-yukkuri" target="_blank"
            ...
            Try to find different types of food. Grown food is the best type in the early game. In addition to that, look
            for a village. They usually has multipple types of food. In addition to that, look for other more interesting
            types of food like melons, pumpkin pie, cookies, and so on.<br />
            <br />
            <span style="font-size: 20px">The enemies are so hard early game because of low health</span><br />
            First of, remember that running is always an option. If you can, avoid the enemy. Also, make sure to always be
            aware of your surroundings. In addition to that, try to look for lifeblood hears. They should spawn in dungeon
            chests (both overworld and nether, although maybe a bit more in the nether). You will also receive a lifeblood
            heart once you have gone through the rules (once that's in place).<br />
            <br />
