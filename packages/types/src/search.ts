...
import type { Kysely, SelectQueryBuilder, Simplify } from 'kysely'
...
export function makePostOutObj(res: SelectResult<ReturnType<typeof postSelectQuery>>) {
  return {
    id: res.postId,
...
export function makeTopicOutObj(res: SelectResult<ReturnType<typeof topicSelectQuery>>) {
  return {
    id: res.topicId,
